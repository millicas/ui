...
function Histronia:CreateUI()
    ...
    CloseButton.MouseButton1Click:Connect(function()
        TweenService:Create(self.MainFrame, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {
...
function Tab:AddDropdown(text, options, callback)
    ...
    for _, option in ipairs(options) do
        ...
        OptionButton.MouseEnter:Connect(function()
            TweenService:Create(OptionButton, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(45, 45, 50)}):Play()
        end)
        
        OptionButton.MouseLeave:Connect(function()
            TweenService:Create(OptionButton, TweenInfo.new(0.2), {BackgroundColor3 = self.Theme.Secondary, BackgroundTransparency = 0.3}):Play()
        end)
    ...
    DropdownButton.MouseButton1Click:Connect(function()
        ...
        if isOpen then
            ...
            TweenService:Create(DropdownFrame, TweenInfo.new(0.2), {Size = UDim2.new(1, 0, 0, 50 + optionsHeight + 5)}):Play()
        else
            Arrow.Text = "▼"
            TweenService:Create(OptionsFrame, TweenInfo.new(0.2), {Size = UDim2.new(1, -30, 0, 0)}):Play()
            TweenService:Create(DropdownFrame, TweenInfo.new(0.2), {Size = UDim2.new(1, 0, 0, 50)}):Play()
